...
class _DoctorMyDevicesState extends State<DoctorMyDevices> {
  ...
  void initState() {
    super.initState();
    context.read<BlocDevices>().add(FetchDevices());
    SystemChrome.setPreferredOrientations([
      DeviceOrientation.portraitDown,
      DeviceOrientation.portraitUp,
    ]);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: BlocBuilder<BlocDevices, DevicesState>(
                ...
                case PostStatus.success:
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final item = state.deviceList[index];
                        ...
                        return Column(children: [
                          // for(focusedDevices['isAssigned'] == true && focusedDevices['addTofocus'] == true)
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 30),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
